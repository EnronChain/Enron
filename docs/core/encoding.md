...
Learn about the encoding formats used on Enron. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Enron does not
...
allows for quick reconstruction of encoded data. Enron uses RLP to encode/decode Ethereum
...
Learn how [pending state](./pending_state.md) is handled on Enron. {hide}
