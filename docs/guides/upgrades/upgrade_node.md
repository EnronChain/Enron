...
You will need to ensure that the version installed matches the one needed for th testnet. Check the Enron [release page](https://github.com/enronchain/enron/releases) for details on each release.
