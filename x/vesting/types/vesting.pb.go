...
// source: enron/vesting/v1/vesting.proto
...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "enron.vesting.v1.ClawbackVestingAccount")
}

func init() { proto.RegisterFile("enron/vesting/v1/vesting.proto", fileDescriptor_5f1a3c86c0cebe5f) }
