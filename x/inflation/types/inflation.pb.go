...
// source: enron/inflation/v1/inflation.proto
...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "enron.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "enron.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("enron/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
