...
// source: enron/inflation/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "enron.inflation.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "enron.inflation.v1.Params")
}

func init() { proto.RegisterFile("enron/inflation/v1/genesis.proto", fileDescriptor_1cb8eee530db1235) }
