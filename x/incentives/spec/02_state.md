...
Say, there are several incentives that have registered an allocation for the $ENRON coin and the allocation meter for $ENRON is at 97%. Then a new incentve proposal can only include an $ENRON allocation at up to 3%, claiming the last remaining allocation capcaity from the $ENRON rewards in the inflation pool.
