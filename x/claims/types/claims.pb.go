...
// source: enron/claims/v1/claims.proto
...
type Claim struct {
	// action enum
	Action Action `protobuf:"varint,1,opt,name=action,proto3,enum=enron.claims.v1.Action" json:"action,omitempty"`
...
func init() {
	proto.RegisterEnum("enron.claims.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "enron.claims.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "enron.claims.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "enron.claims.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("enron/claims/v1/claims.proto", fileDescriptor_a7153f2307523893) }
